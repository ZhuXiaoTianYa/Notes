...
![](assets/项目代码解释/file-20260326230008628.png)
在运行一次程序之后，就会生成build目录，这个目录里面就是项目运行中的一些中间文件，说明编译qt项目还是会用到makefile文件，只是qmake自动帮我们生成了
ui_widget.h就是widget.ui xml生成的.h文件
![](assets/项目代码解释/file-20260326230300795.png)
![](assets/项目代码解释/file-20260326230320149.png)
![](assets/项目代码解释/file-20260326230434752.png)
这里的Ui_widget就是前面.h中的Ui::Widget，虽然名字不太一样