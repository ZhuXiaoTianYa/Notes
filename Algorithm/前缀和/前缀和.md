...
### 724. 寻找数组的中心下标
题目链接：[724. 寻找数组的中心下标](https://leetcode.cn/problems/find-pivot-index/)
![](assets/前缀和/file-20260415111635386.png)
...
![](assets/前缀和/file-20260415111721317.png)
```C++
class Solution {
...
![](assets/前缀和/file-20260415113242856.png)
**解法（前缀和数组）：**
**算法思路：**
...
![](assets/前缀和/file-20260415113333966.png)
...
        vector<int> f(n,1),g(n,1),answer(n);
